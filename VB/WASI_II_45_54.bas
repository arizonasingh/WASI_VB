Attribute VB_Name = "WASI_Age_45_54"
Sub WASI_II_45_54()
...
'BD T score
For Each cell In Range("AF3:AF63")
    If cell = "-" Then
        'Do nothing
...
'VC T score
For Each cell In Range("AG3:AG63")
    If cell = "-" Then
        'Do nothing
...
'MR T score
For Each cell In Range("AH3:AH63")
    If cell = "-" Then
        'Do nothing
...
'SI T score
For Each cell In Range("AI3:AI63")
    If cell = "-" Then
        'Do nothing
